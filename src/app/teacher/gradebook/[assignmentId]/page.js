...
export default async function ClassRecordPage({ params }) {
  ...
  return (
    <AppShell
      ...
      title="Class Record"
      subtitle={`${assignment.subjects.subject_name} · Grade ${assignment.sections.grade_level} ${assignment.sections.section_name}`}
    >
